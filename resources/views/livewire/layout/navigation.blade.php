                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-home"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-home">
                                ...
                                <li class="nav-item"><a class="nav-link" href="../index-2.html" data-bs-toggle=""
                                        aria-expanded="false">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#nv-layouts"
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse"
                                ...
                                <li class="nav-item"><a class="nav-link" href="dark-mode.html" data-bs-toggle=""
                                        aria-expanded="false">
                                ...
                                <li class="nav-item"><a class="nav-link" href="darknav.html" data-bs-toggle=""
                                        aria-expanded="false">
                                        <div class="d-flex align-items-center"><span
                                                class="nav-link-text">Darknav</span></div>
                                    </a><!-- more inner pages-->
                                </li>
                                <li class="nav-item"><a class="nav-link" href="topnav-slim.html" data-bs-toggle=""
                                        aria-expanded="false">
                                ...
                                <li class="nav-item"><a class="nav-link" href="combo-nav.html" data-bs-toggle=""
                                        aria-expanded="false">
                                ...
                                <li class="nav-item"><a class="nav-link" href="dual-nav.html" data-bs-toggle=""
                                        aria-expanded="false">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse"
                                ...
                                <li class="nav-item"><a class="nav-link dropdown-indicator"
                                        href="#nv-navs-_and_-Tabs" data-bs-toggle="collapse" aria-expanded="false"
                ...
                <ul class="dropdown-menu navbar-dropdown-caret">
                    ...
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="layouts" href="#"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="navbar-top-slim.html">
                                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Navbar top slim
                                    </div>
                                </a></li>
                            <li><a class="dropdown-item active" href="navbar-top.html">
