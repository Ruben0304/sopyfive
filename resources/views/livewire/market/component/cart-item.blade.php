<tr class="cart-table-row btn-reveal-trigger">
    ...
    <td class="products align-middle"><a class="fw-semi-bold mb-0 line-clamp-2" href="product-details.html">iPhone 13 pro
    ...
    <td class="size align-middle white-space-nowrap text-700 fs--1 fw-semi-bold">
        XL</td>
    <td class="price align-middle text-900 fs--1 fw-semi-bold text-end">$150
    </td>
