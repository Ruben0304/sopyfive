<tr class="cart-table-row btn-reveal-trigger">
    ...
    <td class="quantity align-middle fs-0 ps-5" style="height: 10px">
        <div class="input-group input-group-sm flex-nowrap" data-quantity="data-quantity">
            <button class="btn btn-sm px-2" wire:click="decrement" data-type="minus" style="background-color: #606060" >-</button>
            ...
            <button class="btn btn-sm px-2" wire:click="increment" data-type="plus" style="background-color: #606060">+</button>
        </div>
    </td>
    ...
    <td class="align-middle white-space-nowrap text-end pe-0 ps-3"><button
            class="btn btn-sm text-500 hover-text-600 me-2" wire:click='removeFromCart' style="background-color: maroon"><span class="fas fa-trash"></span></button></td>
</tr>
