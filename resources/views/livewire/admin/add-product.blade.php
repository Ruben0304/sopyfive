                                ...
                                <form wire:submit="create">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="basic-form-name" type="text"
                                               placeholder="Nombre" wire:model="form.name"/>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-form-name">Precio</label>
                                        <input class="form-control" id="basic-form-name" type="number"
                                               placeholder="Precio" wire:model="form.price"/>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-form-name">Cantidad disponible</label>
                                        <input class="form-control" id="basic-form-name" type="number"
                                               placeholder="Cantidad disponible" wire:model="form.stock"/>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="basic-form-gender">Categoría</label>
                                        <select class="form-select" id="basic-form-gender"
                                                aria-label="Default select example" wire:model="form.category">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" wire:model="form.image"/>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="basic-form-textarea" rows="20"
                                                  placeholder="Descripcion" wire:model="form.description"></textarea>
                                    </div>
