                ...
                <div class="table-responsive scrollbar">
                    <table class="table fs--1 mb-0">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="#!">Carrie Anne</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="#!">Milind Mikuja</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="#!">Stanley Drinkwater</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="#!">Josef Stravinsky</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="#!">Roy Anderson</a></td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="#!">Oscar Wilde</a></td>
