<div class="col-12 col-lg-5 col-xl-4">
    <div class="card">
        <div class="card-body">
            ...
            <div class="w-75">
                <p class="text-700 fs--1 fw-bold line-clamp-1">with 24" iMac® with Retina 4.5K display
            ...
            <div class="border-dashed border-y py-4">
                <div class="d-flex align-items-center mb-5">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"
                        ...
                        href="product-details.html"> <img class="border rounded"
                            src="../../../assets/img/products/2.png" width="53" alt="" /></a>
                ...
                <div class="d-flex align-items-center mb-0">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox" /><label
                            ...
                            alt="" /></a>
                    <div class="ms-2"><a class="fs--1 fw-bold line-clamp-2 mb-2" href="product-details.html">Apple
                            Magic Mouse (Wireless, Rechargable) -
            ...
            <div class="d-flex align-items-end justify-content-between pt-3">
                ...
                <div class="btn btn-outline-warning">Add 3 items to cart<span class="fas fa-shopping-cart ms-2"></span>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp3\htdocs\sopyfive\resources\views/livewire/market/component/similar-products.blade.php ENDPATH**/ ?>