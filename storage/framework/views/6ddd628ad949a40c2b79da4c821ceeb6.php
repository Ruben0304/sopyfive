    ...
    <div class="col-12 col-xl-6">
        <div class="best-in-market-banner d-flex h-100 px-4 px-sm-7 py-5 px-md-11 rounded-3 overflow-hidden">
            ...
            <div class="row align-items-center w-sm-100">
                <div class="col-8">
                    <div class="banner-text light">
                        <h2 class="text-white fw-bolder fs-sm-4 mb-5">MI 11 Pro<br><span class="fs-1 fs-sm-2"> Best in
                                the market</span></h2><a class="btn btn-lg btn-warning rounded-pill banner-button"
                            href="#!">Buy
                            Now</a>
                    </div>
                </div>
...
<?php /**PATH C:\xampp3\htdocs\sopyfive\resources\views/livewire/market/component/banners-promo.blade.php ENDPATH**/ ?>