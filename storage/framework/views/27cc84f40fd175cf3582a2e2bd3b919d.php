<form class="mb-9" wire:submit='save'>
  ...
  <div class="row g-5">
    <div class="col-12 col-xl-8">
      <h4 class="mb-3">Product Title</h4><input class="form-control mb-5" type="text" placeholder="Write title here..."  wire:model='name'/>
      <div class="mb-6">
        <h4 class="mb-3"> Product Description</h4><textarea class="tinymce" name="content" data-tinymce='{"height":"15rem","placeholder":"Write a description here..."}' wire:model='description'></textarea>
      </div>
            ...
            <div class="tab-pane fade show active" id="pricingTabContent" role="tabpanel">
              ...
              <div class="row g-3">
                <div class="col-12 col-lg-6">
                  <h5 class="mb-2 text-1000">Regular price</h5><input class="form-control" type="text" placeholder="$$$" wire:model='price'/>
                </div>
                <div class="col-12 col-lg-6">
            ...
            <div class="tab-pane fade h-100" id="restockTabContent" role="tabpanel" aria-labelledby="restockTab">
              <div class="d-flex flex-column h-100">
                ...
                <div class="row g-3 flex-1 mb-4">
                  <div class="col-sm-7"><input class="form-control" type="number" placeholder="Quantity" wire:model='stock'/></div>
                  <div class="col-sm"><button class="btn btn-primary" type="submit"><span class="fa-solid fa-check me-1 fs--2"></span>Confirm</button></div>
                </div>
                <table>
                  <thead>
                    <tr>
...
</form><?php /**PATH C:\xampp3\htdocs\sopyfive\resources\views/livewire/market/admin/add-product.blade.php ENDPATH**/ ?>