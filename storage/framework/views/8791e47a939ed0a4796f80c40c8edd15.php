...
$__html = app('livewire')->mount($__name, $__params, 'yyRFrlL', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'ois9jIR', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div id="back-top" style="background-color: #606060; z-index: 99999">
                <a title="Go to Top" href="<?php echo e(route('encuesta')); ?>" > <i ><img src="landing/assets/img/icon/gift.png" alt="" width="65%"></i></a>
            </div>
...
<?php /**PATH C:\xampp3\htdocs\sopyfive\resources\views/layouts/landing.blade.php ENDPATH**/ ?>