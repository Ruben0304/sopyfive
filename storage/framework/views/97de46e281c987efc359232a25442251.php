<li class="nav-item dropdown"><a class="nav-link px-2" id="navbarDropdownUser" href="#" role="button"
        data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span
            class="text-700" data-feather="user" style="height:20px;width:20px;"></span></a>
        ...
        <div class="card position-relative border-0">
            <div class="card-body p-0">
                <div class="text-center pt-4 pb-3">
                    ...
                    <h6 class="mt-2 text-black"><!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
            ...
            <div class="card-footer p-0 border-top">
                ...
                <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100"
                        href="<?php echo e(route('logout')); ?>"> <span class="me-2" data-feather="log-out">
                        </span>Sign out</a></div>
...
<?php /**PATH C:\xampp3\htdocs\sopyfive\resources\views/livewire/market/component/nav-user.blade.php ENDPATH**/ ?>