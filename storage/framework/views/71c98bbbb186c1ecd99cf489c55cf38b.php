<li class="nav-item dropdown"><a class="nav-link px-2 icon-indicator icon-indicator-sm icon-indicator-danger"
        id="navbarTopDropdownNotification" href="#" role="button" data-bs-toggle="dropdown"
        data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="text-700" data-feather="bell"
            style="height:20px;width:20px;"></span></a>
    <div class="dropdown-menu dropdown-menu-end notification-dropdown-menu py-0 shadow border border-300 navbar-dropdown-caret mt-2"
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-1 me-sm-3">
                                        ...
                                        <p class="fs--1 text-1000 mb-2 mb-sm-3 fw-normal">
                                            <span class='me-1 fs--2'>💬</span>Mentioned you
                                            in a comment.<span class="ms-2 text-400 fw-bold fs--2">10m</span>
                                        </p>
                            ...
                            <div class="d-flex align-items-center justify-content-between position-relative">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-1 me-sm-3">
                                        ...
                                        <p class="fs--1 text-1000 mb-2 mb-sm-3 fw-normal">
                                            <span class='me-1 fs--2'>👤</span>Tagged you in
...
<?php /**PATH C:\xampp3\htdocs\sopyfive\resources\views/livewire/market/component/nav-orders.blade.php ENDPATH**/ ?>